                        ...
                        {cartItems.map((item) => (
                            <div key={item.id} className="flex items-center mb-4">
                                ...
                                <div className="flex items-center space-x-2">
                                    <button
                                        onClick={() => increaseQuantity(item.id)} // Increase based on unique id
                                    ...
                                    <button
                                        onClick={() => {
                                            if (item.quantity > 1) {
                                                decreaseQuantity(item.id); // Decrease based on unique id
                                            } else {
                                                removeItemFromCart(item.id); // Remove based on unique id
                                            }
                                        }}
                                        className="text-lg px-2 py-1 bg-gray-200 rounded-md"

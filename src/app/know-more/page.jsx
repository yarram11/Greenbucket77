...
const KnowMore = () => {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen p-4 md:p-0 pt-20 md:pt-0 bg-gray-100">
      <h1 className="text-3xl md:text-5xl font-bold mb-4 text-green-600 restaurant-heading text-center">
        We Invite You to Savor the Flavors of Our Restaurant!
      </h1>
      <p className="text-base md:text-xl text-gray-700 mb-6 restaurant-description max-w-2xl text-center">
